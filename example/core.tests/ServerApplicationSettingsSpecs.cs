...
{       
    public class ServerApplicationSettingsSpecs : IDisposable
    {
        ServerApplicationSettings TestSettings = null;
             
        public ServerApplicationSettingsSpecs()
        {
            TestSettings = new ServerApplicationSettings(new RawApplicationSettingsSource());
        }
