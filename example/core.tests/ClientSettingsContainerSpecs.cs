...
{       
    public class ClientSettingsContainerSpecs : IDisposable
    {
        ClientApplicationSettings TestClientSettings = null;
             
        public ClientSettingsContainerSpecs()
        {
            TestClientSettings = new ClientApplicationSettings(new RawApplicationSettingsSource());
        }
